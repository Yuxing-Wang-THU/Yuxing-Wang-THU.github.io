...
<p style="text-align:justify;"> As a researcher in Embodied AI, my passion lies in Robot Co-Design, Evolutionary Learning, and Large Models. I focus on the simultaneous coordination of controlling brain, body morphology, and task environment to design embodied agents that are not only structurally sound but also behaviorally adept (Design a machine that can design other machines).</p>
